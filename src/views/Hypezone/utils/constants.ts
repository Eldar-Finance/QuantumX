export const hypeFarmIds = [20, 21, 22, 33, 36, 37]; // originals ids [11 12 13]
export const dualPoolIds = [36, 37]; // originals ids [11 12 13]

export const hypePools1Ids = [23, 24]; // originals ids [14 15]

export const hypePools2Ids = [25, 26, 27, 32]; // originals ids [16 17 18]
